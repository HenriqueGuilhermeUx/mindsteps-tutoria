...
export function EnemHubPage() {
  ...
  return <main className="ms-screen space-y-5 py-4">
    ...
    <section className="rounded-[28px] border border-indigo-100 bg-gradient-to-br from-indigo-50 to-white p-5"><div className="flex items-start gap-3"><span className="flex h-11 w-11 shrink-0 items-center justify-center rounded-2xl bg-indigo-600 text-white"><BrainCircuit className="h-5 w-5"/></span><div><p className="text-xs font-black uppercase tracking-wider text-indigo-600">Novo · Coach adaptativo</p><h2 className="mt-1 text-lg font-black">Seu texto escolhe seu próximo treino.</h2><p className="mt-1 text-sm leading-5 text-slate-500">Escreva, salve e receba um foco claro para a próxima versão.</p><button onClick={()=>navigate('/enem/redacao/coach')} className="mt-3 text-sm font-black text-indigo-700">Abrir meu coach →</button></div></div></section>
