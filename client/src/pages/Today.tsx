...
import { ArrowRight, BrainCircuit, Camera, ChevronRight, Compass, Dna, FileText, Flame, GraduationCap, Link2, Loader2, MessageCircle, RefreshCw, Shuffle, Sparkles, Target } from 'lucide-react'
