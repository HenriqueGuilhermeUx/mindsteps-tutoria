...
<Route path="/enem" element={<StudentRoute title="MindSteps ENEM"><EnemHubPage /></StudentRoute>} /><Route path="/enem/redacao" element={<StudentRoute title="Redação ENEM"><EnemWritingLabPage /></StudentRoute>} /><Route path="/enem/redacao/escrever" element={<StudentRoute title="Estúdio de Escrita"><EnemWritingStudioPage /></StudentRoute>} /><Route path="/enem/redacao/coach" element={<StudentRoute title="Coach de Escrita"><EnemWritingCoachPage /></StudentRoute>} /><Route path="/enem/redacao/treino/:kind" element={<StudentRoute title="Treino de Escrita"><EnemWritingDrillPage /></StudentRoute>} /><Route path="/enem/redacao/repertorio" element={<StudentRoute title="Repertório Vivo"><EnemRepertoireLabPage /></StudentRoute>} /><Route path="/enem/redacao/comparar" element={<StudentRoute title="Evolução da Escrita"><WritingVersionComparePage /></StudentRoute>} /><Route path="/enem/redacao/dna" element={<StudentRoute title="DNA da Escrita"><WritingDNAPage /></StudentRoute>} /><Route path="/enem/redacao/temas" element={<StudentRoute title="Temas ENEM"><EnemThemeEnginePage /></StudentRoute>} />
