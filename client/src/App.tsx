...
function App() {
  return <div className="min-h-screen bg-slate-50"><Routes>
    ...
    <Route path="/enem" element={<StudentRoute title="MindSteps ENEM"><EnemHubPage /></StudentRoute>} /><Route path="/enem/redacao" element={<StudentRoute title="Redação ENEM"><EnemWritingLabPage /></StudentRoute>} />
