...
import { TrustLearningPage } from '@/pages/TrustLearning'
...
import { SchoolLandingPage } from '@/pages/SchoolLanding'
import { SchoolOperationsPage } from '@/pages/SchoolOperations'
...
import { IndependentLearningPage } from '@/pages/IndependentLearning'
import { MobileResponsibleLearningPage } from '@/pages/MobileResponsibleLearning'
...
import { EnemWritingIndependentPage } from '@/pages/EnemWritingIndependent'
...
<Route path="/como-aprendemos" element={<><Header /><TrustLearningPage /><Footer /></>} />
<Route path="/comecar" element={<><Header /><StartPage /><Footer /></>} /><Route path="/estudar-em-casa" element={<><Header /><HomeStudyPage /><Footer /></>} /><Route path="/tour" element={<><Header /><ProductTourPage /><Footer /></>} /><Route path="/academia" element={<><Header /><LearningCenterPage /><Footer /></>} /><Route path="/empresa" element={<><Header /><CompanyPage /><Footer /></>} /><Route path="/roadmap" element={<><Header /><RoadmapPage /><Footer /></>} /><Route path="/seguranca" element={<><Header /><SafetyPage /><Footer /></>} /><Route path="/acessibilidade" element={<><Header /><AccessibilityPage /><Footer /></>} /><Route path="/genoma" element={<><Header /><LearningGenomePage /><Footer /></>} /><Route path="/grafo" element={<><Header /><KnowledgeGraphPage /><Footer /></>} /><Route path="/testes" element={<><Header /><TestLabPage /><Footer /></>} /><Route path="/protocolo" element={<><Header /><TestProtocolPage /><Footer /></>} /><Route path="/inteligencia" element={<><Header /><IntelligenceLabPage /><Footer /></>} /><Route path="/simulador" element={<><Header /><ScenarioSimulatorPage /><Footer /></>} /><Route path="/feedback" element={<><Header /><FeedbackLabPage /><Footer /></>} />
<Route path="/escola" element={<><Header /><SchoolLandingPage /><Footer /></>} /><Route path="/escola/painel" element={<ProtectedRoute><InstitutionalLayout><SchoolDashboardPage /></InstitutionalLayout></ProtectedRoute>} /><Route path="/escola/configuracao" element={<ProtectedRoute><InstitutionalLayout><SchoolSetupPage /></InstitutionalLayout></ProtectedRoute>} /><Route path="/escola/implantacao" element={<ProtectedRoute><InstitutionalLayout><SchoolOperationsPage /></InstitutionalLayout></ProtectedRoute>} /><Route path="/rede" element={<InstitutionalLayout><NetworkDashboardPage /></InstitutionalLayout>} /><Route path="/pesquisa" element={<><Header /><ResearchDashboardPage /><Footer /></>} /><Route path="/piloto" element={<><Header /><PilotCenterPage /><Footer /></>} />
